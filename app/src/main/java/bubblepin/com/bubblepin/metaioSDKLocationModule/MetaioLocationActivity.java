...
public class MetaioLocationActivity extends ARViewActivity {
    ...
    public void onDrawFrame() {
        if (metaioSDK != null && mSensors != null) {
            ...
            for (MetaioMemory memory : memories) {
    ...
    protected void loadContents() {
        ...
        for (MemoryLocation memoryLocation : memoryLocations) {
            ...
            MetaioMemory curMemory = new MetaioMemory(objectId, coordinateGeo);
        ...
        alertDialogBuilder
                ...
                .setPositiveButton(getString(R.string.detail), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(MetaioLocationActivity.this, MemoryDetailActivity.class);
            ...
            try {
                texture =
                        ARELInterpreterAndroidJava.getAnnotationImageForPOI(title, title, distance, "5", thumbnail,
                                null,
                                metaioSDK.getRenderSize(), MetaioLocationActivity.this,
